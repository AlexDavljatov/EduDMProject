...
<li class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
        <li class="form-container"><g:if test="${flash.message}">
            ...
            <g:form controller="auth" action="signIn" method="get" accept-charset="UTF-8">
            <%--				<form action="login" method="post" accept-charset="UTF-8">--%>
                ...
                <input style="float: left; margin-right: 10px;" type="checkbox" name="remember-me" id="remember-me"
                       value="1">
                <label class="string optional" for="user_remember_me" value="${rememberMe}">Remember me</label>
