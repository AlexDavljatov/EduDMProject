<%@ page import="edu.dm.security.ShiroUser" %>
			...
			<div class="${hasErrors(bean: shiroUserInstance, field: 'email', 'error')} required">
				<label for="email" class="control-label"><g:message code="shiroUser.email.label" default="Email" /><span class="required-indicator">*</span></label>
				<div>
			...
			<div class="${hasErrors(bean: shiroUserInstance, field: 'firstName', 'error')} required">
				<label for="firstName" class="control-label"><g:message code="shiroUser.firstName.label" default="First Name" /><span class="required-indicator">*</span></label>
				<div>
			...
			<div class="${hasErrors(bean: shiroUserInstance, field: 'lastName', 'error')} required">
				<label for="lastName" class="control-label"><g:message code="shiroUser.lastName.label" default="Last Name" /><span class="required-indicator">*</span></label>
				<div>
			...
			<div class="${hasErrors(bean: shiroUserInstance, field: 'components', 'error')} ">
				<label for="components" class="control-label"><g:message code="shiroUser.components.label" default="Components" /></label>
				<div>
					<g:select class="form-control" name="components" from="${edu.dm.course.component.Component.list()}" multiple="multiple" optionKey="id" size="5" value="${shiroUserInstance?.components*.id}" class="many-to-many"/>
			...
			<div class="${hasErrors(bean: shiroUserInstance, field: 'courses', 'error')} ">
				...
				<div>
					<g:select class="form-control" name="courses" from="${edu.dm.course.Course.list()}" multiple="multiple" optionKey="id" size="5" value="${shiroUserInstance?.courses*.id}" class="many-to-many"/>
			...
			<div class="${hasErrors(bean: shiroUserInstance, field: 'roles', 'error')} ">
				...
				<div>
					<g:select class="form-control" name="roles" from="${edu.dm.security.ShiroRole.list()}" multiple="multiple" optionKey="id" size="5" value="${shiroUserInstance?.roles*.id}" class="many-to-many"/>
