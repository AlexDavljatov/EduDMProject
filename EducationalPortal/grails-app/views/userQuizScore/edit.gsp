...
<body>
	...
	<section id="edit-userQuizScore" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${userQuizScoreInstance?.id}" />
			<g:hiddenField name="version" value="${userQuizScoreInstance?.version}" />
