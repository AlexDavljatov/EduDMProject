...
class ShiroRoleController {
    ...
    def save(ShiroRole shiroRoleInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'shiroRoleInstance.label', default: 'ShiroRole'), shiroRoleInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'shiroRoleInstance.label', default: 'ShiroRole'), params.id])
                redirect action: "index", method: "GET"
            }
