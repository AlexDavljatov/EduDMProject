...
class ScoreController {
    ...
    def save(Score scoreInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'scoreInstance.label', default: 'Score'), scoreInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'scoreInstance.label', default: 'Score'), params.id])
                redirect action: "index", method: "GET"
            }
