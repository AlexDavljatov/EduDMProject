...
<html>
	...
	<body>
		<a href="#edit-component" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-component" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${componentInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:componentInstance, action:'update']" method="PUT" >
